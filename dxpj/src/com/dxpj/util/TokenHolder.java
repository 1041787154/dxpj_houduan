...
public class TokenHolder {
	...
	/**
	 * * @param apiKey 网页上申请语音识别应用获取的apiKey * @param secretKey
	 * 网页上申请语音识别应用获取的secretKey
	 */
	...
	/** * 获取token，refresh 方法后调用有效 * * @return */
	public String getToken() {
		return token;
	}

	/** * 获取过期时间，refresh 方法后调用有效 * * @return */
	public long getExpiresAt() {
		return expiresAt;
	}

	/**
	 * * 获取token * * @return * @throws IOException http请求错误 * @throws
	 * DemoException http接口返回不是 200, access_token未获取
	 */
	...
	/** * @param result token接口获得的result * @throws DemoException */
